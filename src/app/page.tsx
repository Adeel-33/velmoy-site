    ...
    <div className="min-h-screen w-full bg-white text-white">
        ...
        <div className="relative mx-auto max-w-6xl px-4 sm:px-5 pt-4 sm:pt-6 md:px-10 lg:px-6 overflow-hidden">
          ...
          <nav className="relative flex items-center justify-between py-2 sm:py-3">
            <div className="flex items-center gap-3 z-10">
              <Link
                href="/"
                className="nav-logo-wraper w-inline-block w--current"
              >
                <Image
                  src="/velmoy-logo.png"
            ...
            <div className="div-block relative z-10">
              ...
              >
                ...
                {/* Text */}
                <span
                  className={`text-[10px] xs:text-xs sm:text-sm font-medium text-white hidden sm:inline whitespace-nowrap ${Inter.className} `}
                >
                  Kontaktiere Uns
                </span>
              </Link>
          ...
          <div className="hero relative flex flex-col items-center py-6 sm:py-8 md:py-12 lg:py-16 xl:py-20 text-center">
            <div className="relative z-10 max-w-3xl space-y-3 sm:space-y-4 md:space-y-5 lg:space-y-7 px-3 sm:px-4 md:px-6">
              ...
              <div
                className={`${Inter.className} font-normal text-[14px] md:text-[18px] max-w-[495px] mx-auto`}
              >
                <p>
                  Design. Development. Growth. – Strategisch gestaltet,
                  technisch perfekt umgesetzt und auf Wachstum optimiert.
                </p>
              </div>
              ...
              <div className="pt-3 sm:pt-4">
                ...
                >
                  ...
                  {/* Text */}
                  <span
                    className={`text-[10px] xs:text-xs sm:text-sm md:text-base font-bold text-black whitespace-nowrap   ${Satoshi.className}`}
                  >
                    Get Started Now
                  </span>
                </Link>
      ...
      >
        ...
        <div className=" col-span-1 max-w-[407px] min-h-[326px]  flex flex-col gap-4 md:gap-2">
          <h1
            className={`${Satoshi.className} relative z-10 font-bold text-[32px] lg:text-[42px] text-[#000D0D]`}
          >
            Den Mehrwert klar erklären, ohne die Seite zu überladen.
          </h1>
          <p
            className={`max-w-[384px] ${Inter.className} relative z-10 text-[#4E4E4E] text-[16px] font-normal`}
          >
            Extrem moderne, hervorragend gestaltete Websites, die Marken
            hervorheben und Conversions steigern.
          </p>
          ...
          <div className="w-[207px] h-[56px] flex items-center justify-center ">
            <div className="flex gap-3 items-center ">
              ...
              <h1
                className={` ${Satoshi.className} relative z-10 font-bold text-[16px] text-[#000D0D]`}
              >
                Get Started Now
              </h1>
            </div>
            ...
            <div key={value.id}>
              <div className=" relative z-10 min-h-[54px]  flex items-center  gap-2">
                ...
                <div className=" w-full min-h-[54px] flex flex-col ">
                  <h1
                    className={` ${Satoshi.className} font-bold text-[20px] text-[#000D0D]`}
                  >
                    {value.heading}
                  </h1>
                  <p
                    className={` ${Inter.className} text-[#4E4E4E] text-[14px]`}
                  >
                    {value.para}
                  </p>
                </div>
